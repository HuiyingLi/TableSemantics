...
public class Lexer {
	...
	public static ArrayList<Part> tokenizeField(String field) {
		...
		if(field.equals("") || field == null) {
			System.err.println("Lexer got empty string or null string in tokenizeField") ;
			return part_list ;
		}
		...
		while(true) {
			...
			System.err.println("Can't tokenize since field part not matching either alpha or numeric or symbol") ;
			System.exit(1);
		}
		return part_list ;
	}
